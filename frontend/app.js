...
class AgentChat {
    ...
    async checkBackendStatus() {
        try {
            ...
            const backendUrl = this.backendUrl || (this.backendUrlInput ? this.backendUrlInput.value : null) || 'http://localhost:8009';
    ...
    async tryAlternativePorts() {
        ...
        const portsToTry = [
            ...
            8009,    // Fallback to generated port
    ...
    getBackendUrl() {
        return this.backendUrl || (this.backendUrlInput ? this.backendUrlInput.value : null) || 'http://localhost:8009';
    }
